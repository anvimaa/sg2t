      ...
      data.forEach((marking) => {
        ...
        layer.on("click", function (event) {
          ...
          var popupContent =
            ...
            '<input value="' +
            marking.name +
            '" type="text" placeholder="Nome do Local" id="name" name="name" class="form-control"/>' +
            "</div>" +
            '<div class="form-group">' +
            '<label class="control-label"><strong>Código: </strong></label>' +
            '<input value="' +
            marking.code +
            '" type="text" placeholder="Código" id="code" name="code" class="form-control"/>' +
            "</div>" +
            '<div class="form-group">' +
            '<label class="control-label"><strong>Referência: </strong></label>' +
            '<input value="' +
            marking.ref +
            '" type="text" placeholder="Referência" id="ref" name="ref" class="form-control"/>' +
            "</div>" +
            '<div class="form-group">' +
            '<div style="text-align:center;"><button type="submit" value="submit" class="btn btn-primary trigger-submit">Salvar</button></div>' +
            "</div>" +
